...
public class InvoiceEmail extends KillBillObject {
    ...
    @JsonCreator
    public InvoiceEmail(@JsonProperty("accountId") final UUID accountId,
    ...
    public void setNotifiedForInvoices(final boolean isNotifiedForInvoices) {
        this.isNotifiedForInvoices = isNotifiedForInvoices;
    }

    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("InvoiceEmail{");
    ...
    public boolean equals(final Object o) {
        ...
        final InvoiceEmail that = (InvoiceEmail) o;
